...
ENV BLENDER_URL https://mirror.clarkson.edu/blender/release/Blender$BLENDER_VERSION/blender-$BLENDER_VERSION.3-linux-x64.tar.xz
...
RUN sudo apt-get install -y software-properties-common && \
    ...
    sudo apt-get install -y apt-transport-https ca-certificates curl wget gcc gnupg2 xz-utils libgl1-mesa-dev libglu1-mesa libxi6 libxrender1 && \
    sudo apt-get update && \
    ...
    cat /etc/fuse.conf >> /home/$USERNAME/fuse.conf && \
...
RUN sudo chown -R $USER_UID:$USER_GID /home/$USERNAME/miniconda3/ && \
    ...
    /home/$USERNAME/miniconda3/bin/conda create -p /home/$USERNAME/miniconda3/envs/anatools python=$PYTHON_VERSION pyyaml pytest numpy imageio opencv && \
    #/home/$USERNAME/miniconda3/bin/conda install -n anatools -c conda-forge -c rapidsai-nightly cudatoolkit && \
    /home/$USERNAME/miniconda3/envs/anatools/bin/pip install anatools && \
